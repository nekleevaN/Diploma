...
![Вітальна сторінка](screenshots/Вітальна_сторінка.png)
![Реєстрація](screenshots/Сторінка_реєстрації.png)
![Лист верифікації](screenshots/Лист_з_верифікацією_при_реєстрації.png)
![Верифікація через Дію](screenshots/Верифікація_через_Дію_mock.png)
...
![Головна з сортуванням](screenshots/Головна_сторінка_з_сторуванням.png)
![Головна з фільтрами](screenshots/Головна_сторінка_з_фільтрами.png)
![Карта оголошень](screenshots/Карта_оголошень.png)

---

### Оголошення

![Сторінка оголошення](screenshots/Сторінка_перегляду_оголошення.png)
![Створення оголошення](screenshots/Сторінка_створення_оголошення.png)

---

### Торг (цінові пропозиції)

![Пропозиція торгу](screenshots/Пропозиція_торгу.png)
![Зміна ціни після торгу](screenshots/Зміна_ціни_оголошення_після_успішного_торгу.png)
![Сповіщення про торг продавцеві](screenshots/Сповіщення_про_торг_продавцеві.png)

---

### Домовленість про перегляд

![Перегляд — покупець](screenshots/Домовленість_про_перегляд_Покупець.png)
![Перегляд — продавець](screenshots/Домовленість_про_перегляд_Продавець.png)
![Лист довіреній особі (email)](screenshots/Лист_довіреній_особі_email.png)
![Повідомлення довіреній особі (Telegram)](screenshots/Повідомлення_довіреній_особі_telegram.jpeg)
![Сповіщення після перегляду](screenshots/Сповіщення_після_перегляду.png)

---

### Купівля та оплата

![Чекаут-сторінка](screenshots/Чекаут-сторінка.png)
![Купівля без доставки](screenshots/Купівля_без_доставки.png)
![Сторінка оплати](screenshots/Сторінка_оплати.png)
![Успішна оплата (Monobank)](screenshots/Успішна_оплата_monobank.png)
![Успішна оплата (додаток)](screenshots/Успішна_оплата_додаток.png)
![Сповіщення про замовлення продавцю](screenshots/Сповіщення_про_замовлення_Продавцю.png)

---

### Доставка

![Створення ТТН продавцем](screenshots/Створення_ТТН_Продавцем.png)
![Статус доставки — ТТН](screenshots/Статус_доставки_ТТН_Покупець.png)
![Статус доставки — в дорозі](screenshots/Статус_доставки_в_дорозі_Покупець.png)
![Статус доставки — здано у відділення](screenshots/Статус_доставки_здано_у_відділення_НП_Покупець.png)
![Статус доставки — прибуло](screenshots/Статус_доставки_прибуло_Покупець.png)
![Підтвердження отримання](screenshots/Підтверження_отримання_замовлення_Покупцем.png)

---

### Антифрод-аналіз чату

![Антифрод-аналіз 1](screenshots/Антифрод-аналіз.png)
![Антифрод-аналіз 2](screenshots/Антифрод-аналіз2.png)

---

### Відгуки

![Відгук про покупця](screenshots/Відгук_про_покупця.png)
![Відгук про продавця](screenshots/Відгук_про_продавця.png)

---

### Профіль користувача

![Заповнення профілю](screenshots/Сторінка_заповнення_профілю.png)
![Редагування профілю](screenshots/Сторінка_користувача_у_режимі_редагування.png)
![Профіль з анонімним відгуком](screenshots/Повна_сторінка_користувача_з_анонімним_відгуком.png)
![Профіль з публічним відгуком](screenshots/Повна_сторінка_користувача_з_публічним_відгуком.png)
