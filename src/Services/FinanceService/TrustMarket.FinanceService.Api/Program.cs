...
using Serilog;
using System.Text;
using TrustMarket.FinanceService.Application;
using TrustMarket.FinanceService.Infrastructure;
...
{
    c.SwaggerDoc("v1", new() { Title = "TrustMarket Finance Service", Version = "v1" });
...
app.MapControllers();
app.MapGet("/health", () => Results.Ok(new { status = "healthy", service = "FinanceService" }));
