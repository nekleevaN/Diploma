...
using Serilog;
using System.Text;
using TrustMarket.ReviewService.Application;
using TrustMarket.ReviewService.Infrastructure;
...
{
    c.SwaggerDoc("v1", new() { Title = "TrustMarket Review Service", Version = "v1" });
